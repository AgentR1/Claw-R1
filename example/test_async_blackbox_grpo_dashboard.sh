...
# ── Data paths ───────────────────────────────────────────────────────────────
TRAIN_FILE=${TRAIN_FILE:-/data/wdy/Claw-R1/data/gsm8k/train.parquet}
VAL_FILE=${VAL_FILE:-/data/wdy/Claw-R1/data/gsm8k/test.parquet}
...
python3 -m claw_r1.async_main \
    ...
    trainer.project_name='dashboard_async_blackbox_grpo' \
    trainer.experiment_name='qwen2_5_0_5b_blackbox_gsm8k_grpo_dashboard' \
    ...
    rollout.nnodes=1 \
    async_training.trigger_parameter_sync_step=5 \
